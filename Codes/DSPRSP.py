#Code reprit depuis https://github.com/cszn/DPIR
...
def main():
    ...
    datapath = r"C:\Users"
    datapath = os.path.join(datapath,"Michel","Desktop","PROJET","Codes")

    noise_level_img = 100                 # set AWGN noise level for noisy image
    ...
    testset_name = 'testf'               # set test set,  'bsd68' | 'cbsd68' | 'set12'
    ...
    model_path = os.path.join(datapath, model_pool, model_name+'.pth')
    ...
    L_path = os.path.join(datapath, testsets, testset_name) # L_path, for Low-quality images
    E_path = os.path.join(datapath, results, result_name)   # E_path, for Estimated images
    util.mkdir(E_path)

    logger_name = result_name
    utils_logger.logger_info(logger_name, log_path=os.path.join(datapath, E_path, logger_name+'.log'))
